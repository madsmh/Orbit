...
jupiter = celestial3d.Body('Jupiter', *jupiter_data, JUPITER_MASS, JUPUTER_RADIUS)
...
pluto = celestial3d.Body('pluto', *pluto_data[0][:], NEPTUNE_MASS, NEPTUNE_RADIUS)
...
def gen_coords():
    for i in range(n):
        ...
        pluto.step(dt, neptune_array)

# gen_coords()

# TODO Must create z-coords for the bodies below -- if needed.
